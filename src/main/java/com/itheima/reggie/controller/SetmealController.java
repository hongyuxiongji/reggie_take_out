...
public class SetmealController {
    ...
    public R<String> setmealOffSale(@RequestParam List<Long> ids ){
        log.info("ids:{}",ids);
        setmealService.setmealOffSale(ids);
        return R.success("套餐停售成功");
    }
    @PostMapping("/status/1")
    public R<String> setmealOnSale(@RequestParam List<Long> ids ){
        log.info("ids:{}",ids);
        setmealService.setmealOnSale(ids);
